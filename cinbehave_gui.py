...
REM Version: 1.8 Enhanced - Python PATH Integration (fix unexpected token)
REM ============================================================================
...
:check_msiserver
REM ---- BLOQUE REESCRITO PARA EVITAR ") else (" Y CARACTERES PROBLEMATICOS ----
...
REM Nota: setx recorta PATH > 1024-2048 chars; solo como respaldo.
